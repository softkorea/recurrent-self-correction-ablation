...
|-------|-----------|-----------|-----------------|----------------|
| **Baseline** | 0.698 | 0.739 | **+0.042** | Self-correction occurs |
...
| D'' (Compute-matched FF) | 0.600 | 0.600 | 0.000 | Not a depth effect |

- Baseline 95% CI: **[+0.023, +0.059]** (does not contain zero)
- All seven prespecified primary comparisons significantly different from Baseline (Holm-Bonferroni corrected p < 0.032)
...
│   ├── raw_metrics.csv                   # Full raw data (4,020 rows)
