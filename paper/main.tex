...
\textbf{Fifth}, we show through a parameter-matched feedforward control that the self-correction advantage cannot be explained by additional parameters alone, and through a hyperparameter sweep across 80 configurations that the phenomenon is robust, not an artifact of tuning.
