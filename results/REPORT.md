...
|-------|--------|--------|-----------------|----------------|
| **Baseline** | 0.698±0.054 | 0.739±0.055 | **+0.042±0.029** | Self-correction occurs |
...
| D (Feedforward) | 0.745±0.067 | 0.745±0.067 | 0.000±0.000 | No correction possible (no recurrence) |
| D' (Param-matched FF) | 0.822±0.031 | 0.822±0.031 | 0.000±0.000 | Not a capacity effect |
| D'' (Compute-matched FF) | 0.600±0.130 | 0.600±0.130 | 0.000±0.000 | Not a depth effect |
...
|------------|-------|-------------|--------------|
| Baseline vs C1 | 0.00195 | 0.0137 | * |
| Baseline vs C2 | 0.00195 | 0.0137 | * |
| Baseline vs B1 | 0.00391 | 0.0195 | * |
| Baseline vs A | 0.00781 | 0.0312 | * |
| Baseline vs D | 0.00781 | 0.0312 | * |
| Baseline vs D' | 0.00781 | 0.0312 | * |
| Baseline vs D'' | 0.00781 | 0.0312 | * |
...
| File | Description |
|------|-------------|
| `results/raw_metrics.csv` | Full experiment data (4,020 rows, incl. C2 and D'') |
