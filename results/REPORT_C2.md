...
|-------|----------------|--------|---------|
| **Baseline** | **+0.042±0.029** | [+0.023, +0.059] | — |
| A (Recurrent Cut) | +0.000±0.000 | [0.000, 0.000] | 0.0312 * |
| C1 (Shuffled Feedback) | **-0.064±0.048** | [-0.095, -0.035] | 0.0137 * |
| **C2 (Clone Feedback)** | **-0.059±0.069** | [-0.102, -0.016] | 0.0137 * |
...
| `results/raw_metrics.csv` | 60 C2 rows appended (total 4,020 with D'') |
